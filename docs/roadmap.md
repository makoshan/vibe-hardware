...
| **问世** | 6. 宣发 | Demo、照片、说明书、源码和 BOM | [案例库](resources.md#21-可复现案例库) |
| **问世** | 7. 小批量制造 | 10–100+ 台，建立测试与售后 | [试产、成本、测试与售后](product-course.md#small-batch) |

## 配套实操教程

[从零到产品：四段七步](product-course.md)与上方主线一一对应，入门实验和制造教程为步骤内的配套资料：

- [需求拆解](product-course.md#requirements)：需求、模块 BOM 与验证。
- [制作初期 PCB](product-course.md#electronics)：链接 EDA、PCB 与 SMT 实操，补充手册、电路判断与返修。
...
| 6. 宣发 | 别人能否按资料复现？ | GitHub、照片、视频 | README、BOM、组装、烧录、演示 | 新的人能在不口头求助下完成核心链路 |
